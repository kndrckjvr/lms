...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2019 at 01:55 PM
...
INSERT INTO `booktbl` (`book_id`, `book_name`, `book_author`, `book_image`, `section_id`) VALUES
(1, 'Book 1', 'Author 1', '', 2),
(2, 'Book 2', 'Author 1', '', 2),
(3, 'Book 3', 'Author 1', '', 1),
(4, 'Book 4', 'Author 1', '', 1),
...
(31, 'Book31', 'Author 1', '', 2),
(32, 'Book32', 'Author 1', '', 1),
(33, 'Book33', 'Author 1', '', 2),
(34, 'Book34', 'Author 1', 'no_image2.png', 1),
(35, 'Book35', 'Author 1', 'IMG_2100.JPG', 2);
...
(7, 31, 'SCI006', 1, 1559892929),
(8, 32, 'NON002', 1, 1559893062),
(9, 33, 'SCI006', 1, 1559893554),
(10, 34, 'NON002', 1, 1559893741),
(11, 35, 'SCI006', 1, 1559893860);
...
--
ALTER TABLE `itembooktbl`
  MODIFY `itembook_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

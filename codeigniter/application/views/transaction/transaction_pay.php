    ...
    <div class="col-10">
        <div class="card shadow mb-5">
            ...
            <div class="card-body">
                ...
                <table class="table-sm table-hover col" id="manage-payment-table">
                    <thead>
                        <tr>
    ...
    function changePage(e) {
        ...
        $.ajax({
            ...
            success: function success(res) {
                $("#manage-payment-table tbody").html("");
                ...
                if (res.userData) {
                    ...
                    $("#manage-payment-table tbody").html("<td colspan='4' class='text-center'>No Book Found.</td>");
                }
            ...
            $.ajax({
                ...
                success: function success(res) {
                    ...
                    if (res.userData) {
                        ...
                        $("#manage-payment-table tbody").html("<td colspan='3' class='text-center'>No User Found.</td>");
                    }

                ...
                if (res.bookData) {
                    res.bookData.forEach(element => {
                        $("#book_card_columns").append("<div class='col-md-4'><div class='card mb-4' style='width: 18rem;'>" +
                            ...
                            "<p class='card-text'> <strong>Book Author :</strong> " + element.book_author + " <br> <strong>Section Name : </strong>" + element.section_name + " <br> <strong>Book Description:</strong> " + (element.book_description == "" ? "None" : element.book_description) + " <br> <strong>Book Quantity:</strong> " + element.book_qty + "</p>" +
                            "</div>" +
                            "<div class='card-body'>" +
